...
**Status:** Proposed (aguarda aprovação humana)  
**Date:** 2026-09-22  
...
4. Preferir stack Drizzle (`empreendimentos`/`acomodacoes`) como SoT de inventário de produto; legado EN como read-adapter até cutover explícito.  
...
### Negative / Risks
- Complexidade de coexistência (dois stacks de property; três “comissões”)  
...
- `backend/drizzle/0022_empreendimentos_parceiros.sql`, `0031_comissoes_lancamento.sql`  
